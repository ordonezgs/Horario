...
if (moment().locale('es').format('L') == "17/04/2019") {
  ...
  if (moment().locale('es').format('L') == "13/06/2019" && moment().hour() > 15 || moment().locale('es').format('L') == "14/06/2019" || moment().locale('es').format('L') == "15/06/2019" || moment().locale('es').format('L') == "16/06/2019" || moment().locale('es').format('L') == "17/06/2019"){
        location.href="inst"
      }else{
